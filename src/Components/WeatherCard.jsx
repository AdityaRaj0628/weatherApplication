...
//  import snowIcons from '../assets/icons/snowIcons.jpg'
...
//                 <p className='font-bold text-5xl flex justify-center items-center'> {tempature} &deg;C</p>
//             </div>
//             <div className='font-bold text-center text-xl'>
//                 {place}
//             </div>
//             <div className='w-full flex justify-between items-center mt-4'>
//                 <p className='flex-1 text-centern p-2'> {new Date().toDateString()}</p>
//                 <p className='flex-1 text-centern p-2'> {time}</p>
//             </div>
//             <div className='w-full flex justify-between items-center mt-4 gap-2'>
//                 <p className='flex text-center p-2 font-bold bg-blue-600 shadow rounded'>Wind Speed <p className='font-normal'>{windspeed}</p></p>
